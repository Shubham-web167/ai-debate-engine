...
function updateTimeline(status) {
  const steps = [
    { el: stepBroadcast, active: ['BROADCASTING', 'WAITING', 'COLLECTING'], done: ['CRITIQUE', 'WAITING_CRITIQUE', 'COLLECTING_CRITIQUE', 'ROUND2', 'WAITING_ROUND2', 'COLLECTING_ROUND2', 'JUDGE', 'WAITING_JUDGE', 'COLLECTING_JUDGE'] },
    { el: stepCritique, active: ['CRITIQUE', 'WAITING_CRITIQUE', 'COLLECTING_CRITIQUE'], done: ['ROUND2', 'WAITING_ROUND2', 'COLLECTING_ROUND2', 'JUDGE', 'WAITING_JUDGE', 'COLLECTING_JUDGE'] },
    { el: stepRound2, active: ['ROUND2', 'WAITING_ROUND2', 'COLLECTING_ROUND2'], done: ['JUDGE', 'WAITING_JUDGE', 'COLLECTING_JUDGE'] },
    { el: stepJudge, active: ['JUDGE', 'WAITING_JUDGE', 'COLLECTING_JUDGE'], done: [] }
  ];
